<!-- Mobile Filter Toggle (Visible on smaller screens) -->
        ...
        <!-- Sidebar / Filters -->
        <aside id="filter-sidebar" class="w-full lg:w-[280px] xl:w-[320px] flex-shrink-0 fixed lg:static top-0 left-0 h-full lg:h-auto z-[100] lg:z-auto liquid-glass bg-black/40 backdrop-blur-2xl border border-white/15 rounded-2xl p-6 overflow-y-auto lg:overflow-visible transition-transform duration-300 transform -translate-x-full lg:translate-x-0 shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] lg:shadow-none">
                        ...
                        <div class="flex items-center justify-center gap-4 mb-4">
                            <div class="flex-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="price_min" value="{{ request('price_min') }}" id="price-min" placeholder="0" class="w-full bg-black/40 border border-white/10 rounded-lg py-1.5 pl-6 pr-2 text-sm text-center font-bold text-white focus:border-primary outline-none transition-all [&::-webkit-inner-spin-button]:appearance-none">
                                </div>
                            </div>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-xs font-bold">P</span>
                                    <input type="number" name="price_max" value="{{ request('price_max') }}" id="price-max" placeholder="250000" class="w-full bg-black/40 border border-white/10 rounded-lg py-1.5 pl-6 pr-2 text-sm text-center font-bold text-white focus:border-primary outline-none transition-all [&::-webkit-inner-spin-button]:appearance-none">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="min-h-0">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="grid grid-rows-[0fr] peer-checked:grid-rows-[1fr] transition-all duration-300 opacity-0 peer-checked:opacity-100 overflow-hidden">
                                    <div class="min-h-0 pl-5 mt-3 space-y-3 border-l border-white/10 ml-2">
            ...
            <!-- Storage Accordion -->
            @if(!empty($counts['storages']))
            <div class="mb-4 border-t border-white/10 pt-6">
            ...
            <!-- Generic Categories / Tags Accordion -->
            @if(!empty($counts['tags']) || !empty($counts['categories']) || !empty($counts['brands']))
            <div class="mb-4 border-t border-white/10 pt-6">
                <input type="checkbox" id="tags-accordion" class="peer hidden" checked>
                <label for="tags-accordion" class="flex items-center justify-between cursor-pointer group mb-4">
                    <h3 class="text-sm font-bold text-white uppercase tracking-widest flex items-center gap-2">
                        <i class="ph ph-tag text-primary"></i> Tags & Categories
                    </h3>
                    <i class="ph ph-caret-down text-gray-500 transition-transform peer-checked:rotate-180"></i>
                </label>
                ...
                <div class="grid grid-rows-[0fr] peer-checked:grid-rows-[1fr] transition-all duration-300 opacity-0 peer-checked:opacity-100 overflow-hidden">
                    <div class="min-h-0 space-y-3 pt-4 pb-2">
                        ...
                        <label class="flex items-center gap-3 group cursor-pointer">
                            <input type="checkbox" name="tags[]" value="{{ $tag }}" class="appearance-none w-4 h-4 shrink-0 border border-[#5a2810] rounded-sm bg-black/40 checked:bg-primary checked:border-primary relative after:content-[''] after:absolute after:hidden checked:after:block after:left-1/2 after:top-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:w-2 after:h-2 after:bg-white after:rounded-full transition-all cursor-pointer" {{ in_array($tag, $reqTags) ? 'checked' : '' }}>
                            <span class="text-sm text-gray-300 group-hover:text-white transition-colors truncate">{{ $tag }}</span>
                            <span class="text-[10px] text-gray-500 ml-auto shrink-0">{{ $count }}</span>
                        </label>
                        @endforeach
                    </div>
